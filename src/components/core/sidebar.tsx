...
export function Sidebar() {
  ...
  const navItems = [
    ...
    { route: "/app/settings", icon: <Settings size={20} />, label: "Settings" },
  ];

  return (
    <aside className="w-full max-w-16 h-screen bg-stone-950 text-white p-2 shadow-md flex flex-col items-center gap-1.5 select-none z-10">
      <img
        alt={"icon"}
...
function NavIcon({
  ...
  return (
    <button
      ...
      onClick={onClick}
      className={`
        w-full h-10 flex items-center justify-start gap-2 px-3 text-center
